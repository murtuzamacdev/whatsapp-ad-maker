...
const Template1 = () => {
    ...
    return (<div style={{ backgroundImage: "url(" + globalContext.productData.productImage + ")" }} className="temp1-ctnr">
        ...
        <div className="mb-3 bottom-ctrn">
            <p className={"product-name pt-2 pb-2 pl-1 pr-1 m-0 single-line " + (hideThisPart(globalContext.productData) ? 'only-product-name' : 'with-absolute')}>{globalContext.productData.productName}</p>
